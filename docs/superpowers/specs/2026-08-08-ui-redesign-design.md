...
5. **Pricing (`#space`):** `--alt` background; overline + "Pay for the time you need. Nothing more."; single-row 3-card grid (Virtual Meeting Pass, Full Day, Monthly); Monthly card inverted in ink with "Best value" sky tag; "Pricing last updated August 8, 2026" + call link below. No emojis, no per-card photos, no inline styles.
...
- Pricing (owner update at PR stage, 2026-08-08): Virtual Meeting Pass ₹350 (1-3 hrs; additional hour ₹100) · Full Day ₹600 · Monthly ₹6,000 (featured). Half-Day, Weekly, and 15-Day plans removed.
